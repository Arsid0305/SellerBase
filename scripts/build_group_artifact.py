...
# группа -> (заголовок, подзаголовок, эмодзи-иконка, части)
GROUPS = {
    "myachi": (
        "Массажные мячи 6 / 7 / 9 см",
        "15 карточек · предмет «мяч массажный» · подгруппа 103 выведена из продажи",
    ...
    "massagers": (
        "Роликовые массажёры 101",
        "3 карточки · предмет 983 · лента 110 см, три цвета",
    ...
    "tabletnitsy": (
        "Таблетницы",
        "10 карточек · предмет 2323 · три конструкции от трёх поставщиков",
