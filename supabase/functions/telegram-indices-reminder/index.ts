...
// индекс локализации, если за прошлую неделю записи нет. Индекс распределения
// продаж WB отключил из расчёта логистики 13.07.2026 — больше не спрашиваем.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const msg = [
      "🗓 <b>Пн — внести индекс локализации за прошлую неделю</b>",
      "",
      `Неделя: <b>${lastMonday}</b>`,
      "",
      "WB не отдаёт эту цифру через API, введи руками:",
      "",
      "1. Открой ЛК WB → Аналитика → <b>Индекс локализации</b>",
      "2. Внеси в проге: <b>/tariffs → Внести значения из ЛК WB</b>",
      "",
