-- Налог УСН считаем как retail_amount × 6% (то что покупатель заплатил × ставка),
-- а не revenue × 6.8%. Согласно книге владелицы «PL WB (нед)».
--
-- Сверка mcp с её файлом за неделю 08-14.06.2026:
--   её файл: tax = 3 363 ₽ (row 15 «Продано ВБ реализовал» 56 049 × 6% = 3 362.94)
--   моя новая формула: retail_amount 56 049 × 6% = 3 363 ✅ идентично
