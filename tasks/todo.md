...
- [ ] **Утренний бриф = параметры WB-стиля**: Количество (шт) + Сумма (₽) — как блоки в WB-кабинете (вместо текстовой строки выручка/шт)
- [ ] **Левый блок (бриф) той же высоты что правый стек (Воронка + Рейтинг)** — выровнять по высоте
- [ ] **FunnelCard заголовок**: убрать « — Воронка продаж», оставить «Аналитика продавца» + добавить «за 30 дней»
